...
class Playground():
    ...
    # 範例提供的為隨機移動的版本，之後會拿我訓好的RBFN模型來替換
    ...
    def _checkDoneIntersects(self):
        ...
        # 找到所有交點中最近的一個，儲存在self.front_intersects等屬性中
